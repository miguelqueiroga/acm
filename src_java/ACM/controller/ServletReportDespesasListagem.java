...
public class ServletReportDespesasListagem extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		try{
			...
			Collections.sort (despesas, new Comparator<DespesaPorVencimento>() {  
			...
			reportFile = new File(sc.getRealPath("WEB-INF/relatorios/Relatorio_Despesas.jasper"));
